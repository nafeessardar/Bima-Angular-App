...
export class CommonLeafletMapComponent {
  ...
  generateMarker(data: { position: L.LatLngExpression; draggable: boolean, icon: L.DivIcon }, index: number) {
    return L.marker(data.position, { draggable: data.draggable, icon: this.customIcon })
